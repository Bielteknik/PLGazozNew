...
export function History({ data }: { data: SystemData }) {
  ...
  return (
    <div className="flex flex-col h-full space-y-3">
      ...
      {/* Header */}
      <div className="bg-[#151921] border border-[#2D333F] p-3 rounded flex items-center justify-between">
        ...
        <div className="relative text-gray-500">
           ...
           <input 
             ...
             className="bg-[#0D1016] border border-[#374151] rounded pl-6 pr-2 py-1 text-[10px] text-gray-200 outline-none focus:border-[#4ade80]"
           />
        </div>
      </div>
